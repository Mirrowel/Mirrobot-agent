...
The **Ask Mirrobot** badge is this project's own: repositories running a Mirrobot deployment can carry it, linking visitors to the [informational page](https://mirrowel.github.io/Mirrobot-agent/) — pass your deployment's bot name via `?bot=` so visitors know who to mention back home. The page ships in `docs/` and publishes through GitHub Pages; edit the `REPOS` list in `docs/index.html` to point the live-activity strip at your own repositories.
