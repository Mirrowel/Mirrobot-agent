...
EXAMPLE_PERMISSIONS = Path(__file__).parent / ".github/actions/bot-setup/permissions.example.json"
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        # No argument provided, use the default: the permission example
        input_file = EXAMPLE_PERMISSIONS
        ...
        print("If no path is provided, will use: .github/actions/bot-setup/permissions.example.json")
        sys.exit(1)
